          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-2.5 lg:justify-start">
              {cities.map((city) => (
                <span
                  key={city}
                  className="inline-flex items-center gap-1.5 rounded-full border border-black/5 bg-surface px-4 py-2 text-sm font-medium text-secondary transition-colors hover:bg-accent-light"
                >
