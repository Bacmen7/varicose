...
const conditions = [
  { name: "Varicose Veins", image: "/user/varicose veins.png", href: "/conditions?c=varicose-veins" },
  { name: "Spider Veins", image: "/user/spider vein.png", href: "/conditions?c=spider-veins" },
  { name: "Deep Vein Reflux", image: "/user/deep vein reflux.png", href: "/conditions?c=dvt-and-leg-swelling" },
  { name: "Chronic Venous Insufficiency", image: "/user/chronic venus insufficiency.png", href: "/conditions?c=chronic-venous-insufficiency" },
  { name: "Leg Pain & Heaviness", image: "/user/leg pain and heaviness.png", href: "/conditions?c=chronic-venous-insufficiency" },
