...
const megaMenuColumns = [
  {
    title: "Information",
    links: [
      { label: "All About Varicose Veins", href: "/conditions?c=varicose-veins" },
      { label: "Varicose Vein Symptoms", href: "/conditions?c=varicose-veins" },
      { label: "Spider Veins", href: "/conditions?c=spider-veins" },
      { label: "Chronic Venous Insufficiency", href: "/conditions?c=chronic-venous-insufficiency" },
      { label: "DVT Awareness", href: "/conditions?c=dvt-and-leg-swelling" },
      { label: "Venous Leg Ulcers", href: "/conditions?c=vein-ulcers" },
      { label: "Post-Pregnancy Veins", href: "/conditions?c=spider-veins" },
    ],
  },
  {
    title: "Treatment",
