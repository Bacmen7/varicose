...
export default function TestimonialsSection() {
  ...
  return (
    <section className="py-14 md:py-20 overflow-hidden relative bg-accent-light">
      <div className="mx-auto w-full max-w-[1320px] px-5 md:px-8 text-left mb-10 md:mb-12">
        <p className="text-[12px] md:text-[13px] font-semibold uppercase tracking-[0.18em] text-primary mb-3">
          Patient Stories
        </p>
        <h2 className="font-heading font-normal tracking-tight leading-[1.2] text-[1.9rem] sm:text-[2.3rem] text-secondary">
          500+ patients.
          <br />
          500+ reasons to seek care earlier.
        </h2>
        <p className="mt-4 text-[15px] md:text-base leading-relaxed text-gray-600 max-w-2xl">
          Here is what some of our patients have shared about their experience
          at Sira Vascular. Real words, real recoveries.
        </p>
