    ...
    <section className="py-14 md:py-20 bg-surface relative">
      <div className="mx-auto w-full max-w-[1320px] px-5 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          ...
          <button className="inline-flex items-center gap-2 bg-primary text-white rounded-full px-6 py-2 text-sm font-semibold hover:bg-primary-dark transition-colors self-start md:self-auto cursor-pointer">
            View All Stories
