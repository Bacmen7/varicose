    ...
    <section className="py-14 md:py-20 w-full bg-surface relative">
      <div className="mx-auto w-full max-w-[1320px] px-5 md:px-8">
        ...
        <div className="flex justify-center">
          <button className="bg-primary text-white rounded-full px-6 py-2 text-sm font-semibold hover:bg-primary-dark transition-colors flex items-center gap-2 group cursor-pointer">
