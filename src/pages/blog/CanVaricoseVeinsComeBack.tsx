...
export default function CanVaricoseVeinsComeBackPage() {
  usePageMeta(
    "Can Varicose Veins Come Back? Recurrence and How to Prevent It",
    "Learn why varicose veins sometimes return after treatment, which options have the lowest recurrence, and simple ways to lower your risk.",
  );
      ...
      <section className="relative pt-14 md:pt-16 pb-14 md:pb-16 bg-primary">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/clinics"
              className="bg-transparent text-white text-base font-semibold py-2 px-6 rounded-full transition-colors hover:bg-white/10 border-2 border-white"
            >
