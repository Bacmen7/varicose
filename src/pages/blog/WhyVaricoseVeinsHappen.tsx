    ...
    <main className="bg-white">
      ...
      <section className="relative bg-surface pt-8 pb-20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-[15px] md:text-base leading-7 mt-4 max-w-2xl" style={{ color: '#48546B' }}>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <ol className="list-decimal list-inside text-[15px] md:text-base leading-7 mb-6 space-y-3 ml-4" style={{ color: '#48546B' }}>
        ...
        <p className="text-[15px] md:text-base leading-7 mb-4" style={{ color: '#48546B' }}>Over time, this leads to:</p>
        <ul className="list-disc list-inside text-[15px] md:text-base leading-7 mb-12 space-y-2 ml-4" style={{ color: '#48546B' }}>
          <li>Bulging veins</li>
        ...
        <p className="text-[15px] md:text-base leading-7 mb-8" style={{ color: '#48546B' }}>
        ...
        <p className="text-[15px] md:text-base leading-7 font-bold mb-12" style={{ color: '#48546B' }}>
        ...
        <div id="when-to-see-doctor" className="bg-cta/10 border border-cta/20 p-6 rounded-xl mb-12 scroll-mt-28">
          ...
          <p className="text-[15px] md:text-base leading-7 mb-4" style={{ color: '#48546B' }}>Don&apos;t wait if you have:</p>
          ...
          <aside className="hidden lg:block lg:w-1/3">
            <div className="sticky top-28 bg-surface rounded-xl p-6">
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <p className="mb-8 text-xs font-semibold uppercase tracking-[0.18em] text-secondary/70">
