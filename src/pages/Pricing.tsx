...
export default function PricingPage() {
  usePageMeta(
    "Treatments & Pricing | Sira Vascular",
    "Transparent vein treatment pricing and specialist consultation options.",
  );
  return (
    <main className="bg-white font-body">
      <section className="bg-[#026460] text-white">
        <div className="mx-auto max-w-[1200px] px-4 py-14 sm:py-16 lg:py-20">
          <p className="mb-5 text-sm font-semibold uppercase tracking-[0.18em] text-white/72">
            Treatments &amp; Pricing
          </p>
