...
function ClinicCard({ clinic }: { clinic: Clinic }) {
  ...
  return (
    <article className="font-body border-b border-[#d8e7e6] px-5 py-5 last:border-b-0">
      <p className="mb-3 inline-block bg-[#d9edeb] px-2 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-primary-dark">
        {clinic.area}
      </p>
...
export default function ClinicsPage() {
  usePageMeta(
    "Our Clinics | Sira Vascular",
    "Find a Sira Vascular vein care clinic near you.",
  );
  return (
