          ...
          <div className="max-w-7xl mx-auto px-6 pt-5 pb-12 md:pt-8 md:pb-14">
            ...
            <div className="max-w-3xl">
              ...
              <a
                ...
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-cta px-6 py-2 text-sm font-semibold text-white transition-all hover:brightness-105 md:mt-8 md:inline-flex md:w-auto"
              >
              ...
              <div className="max-h-[50vh] space-y-3 overflow-y-auto pb-4">
                {tocSections.map((s) => (
                  <button
                    ...
                    className="block w-full text-left text-sm leading-6 text-secondary hover:underline"
                  >
                    {s.label}
                  </button>
                ))}
            ...
            <div className="grid gap-8 md:gap-12 lg:grid-cols-[250px_minmax(0,1fr)]">
                ...
                <div className="space-y-4">
                  {tocSections.map((s) => (
                    <button
                      ...
                      className={`block text-left text-sm leading-7 transition-colors hover:underline ${
              ...
              <div className="min-w-0">
                ...
                <div className="mb-10 bg-accent-lighter p-5 md:mb-14 md:p-7">
                  ...
                  <ul className="space-y-4">
                    {keyTakeaways.map((item, index) => (
                      <li key={index} className="flex gap-3 text-sm leading-8 text-secondary">
                        <span>&bull;</span>
                        <span>{item}</span>
                      </li>
                    ))}
                ...
                <div id="overview" data-toc-section className="mb-8 space-y-4 md:mb-10 md:space-y-6">
                  <p className="text-sm leading-[1.7] text-secondary">
                  ...
                  <p className="text-sm leading-[1.7] text-secondary/80">
                ...
                <div id="who-needs" data-toc-section className="mb-10 md:mb-14">
                  ...
                  <p className="mb-5 text-sm leading-[1.7] text-secondary/80">
                  ...
                  <ul className="list-disc space-y-3 pl-6">
                    {symptoms.map((s, i) => (
                      <li key={i} className="pl-1 text-sm leading-[1.7] text-secondary">{s}</li>
                    ))}
                  </ul>
                </div>
                  ...
                  <div className="relative space-y-10 border-l-2 border-accent pl-8">
                    {steps.map((step, index) => (
                      <div key={index} className="relative">
                        ...
                        <p className="text-sm leading-[1.7] text-secondary/80">{step.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {benefits.map((b, i) => (
                      <div key={i} className="flex gap-4 rounded-xl border border-gray-100 p-5 transition-all hover:border-primary/30 hover:bg-accent-lighter">
                        ...
                        <div>
                          <p className="mb-0.5 text-sm font-semibold text-secondary">{b.title}</p>
                ...
                <div id="vs-surgery" data-toc-section className="mb-10 md:mb-14">
                  ...
                  <p className="mb-5 text-sm text-gray-400">Why modern laser therapy is the preferred choice</p>
                  ...
                  <div className="space-y-3">
                    {faqs.map((faq, i) => (
                      <div key={i} className="overflow-hidden rounded-xl border border-gray-200">
                        ...
                        {openFaq === i && (
                          <div className="border-t border-gray-100 px-5 pb-5 pt-4 text-sm leading-[1.7] text-secondary/80">
                            {faq.a}
                          </div>
                        )}
                      </div>
