...
const conditionRows = [
  ...
  { condition: "DVT Awareness", badge: "Urgent", badgeColor: "#DBEAFE", badgeText: "#1E40AF", first: "Urgent referral, do not wait", next: "Anticoagulant therapy, specialist review", href: "/conditions?c=varicose-veins" },
  ...
  return (
    <main className="bg-background">
      ...
      <section className="py-16 lg:py-20 w-full bg-white">
        <div className="container mx-auto px-4 max-w-[1200px]">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-stretch">
            {/* Dark card */}
            <div className="flex flex-col justify-center rounded-xl p-10 relative overflow-hidden" style={{ backgroundColor: '#026460' }}>
            ...
            <div className="flex flex-col justify-between gap-3">
              {diagSteps.map((s, i) => {
                const Icon = s.icon;
                return (
                  <div key={i} className="flex flex-1 items-center gap-4 bg-surface rounded-xl p-5 border border-transparent hover:border-primary/30 transition-all">
        ...
        <div className="container mx-auto px-4 max-w-[1200px]">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {approachCards.map((card, i) => (
              <div key={i} className="bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-primary/30 hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="relative py-16 lg:pb-20 w-full bg-white">
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            {/* Left visual */}
            <div className="rounded-xl p-10 relative overflow-hidden" style={{ backgroundColor: '#026460' }}>
              <div className="absolute bottom-0 right-0 w-48 h-48 rounded-full opacity-10 bg-white translate-x-1/3 translate-y-1/3" />
      ...
      <section className="py-16 w-full bg-white">
        <div className="container mx-auto px-4 max-w-[1200px]">
          <div className="rounded-xl p-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-8 relative overflow-hidden" style={{ backgroundColor: '#026460' }}>
