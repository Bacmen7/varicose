...
export default function EVLTPage() {
  ...
  return (
    <div className="bg-white text-secondary antialiased font-body text-[16px]">
      <main>
        ...
        <header>
          <div style={{ backgroundColor: "#2C847F" }} className="text-white">
            <div className="max-w-7xl mx-auto px-6 pt-6 pb-12 flex flex-col items-start">
              ...
              <h1 className="font-heading mb-4 text-white font-normal" style={{ fontSize: "clamp(34px, 5vw, 56px)", letterSpacing: "0", lineHeight: 1.1 }}>
                Endovenous Laser Treatment
                <br /><span style={{ fontSize: "0.65em", opacity: 0.75 }}>(EVLT)</span>
              </h1>
              <p className="text-white/80 text-base md:text-[17px] mb-6 max-w-xl leading-relaxed">
                Gold-standard minimally invasive laser therapy for varicose veins. No surgery. No stitches. Walk out the same day.
              </p>
              <a href="#" className="inline-flex items-center text-white text-[15px] font-semibold hover:opacity-80 hover:underline">
            ...
            <div className="max-w-7xl mx-auto px-6 py-4 flex gap-3 overflow-x-auto">
              {navTabs.map((tab) => (
                <button
                  ...
                  className={`inline-block rounded-full px-5 py-2 text-[13px] font-medium whitespace-nowrap transition-colors cursor-pointer ${activeTab === tab.id ? "bg-white text-secondary" : "bg-white/[0.12] text-white hover:bg-white/20"}`}
                >
                  {tab.label}
                </button>
              ))}
            ...
            <div className="lg:flex lg:gap-14">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div id="overview" data-toc-section className="mb-20">
                  <p className="text-[16px] leading-[1.8] text-secondary mb-5">
                  ...
                  <p className="text-[16px] leading-[1.8] text-gray-500 mb-5">
                ...
                <div id="key-facts" data-toc-section style={{ marginBottom: "5rem", paddingTop: "2.5rem", borderTop: "1px solid #e8ecf0" }}>
                  <h2 className="font-heading text-secondary mb-6" style={sectionHeadingStyle}>
                  ...
                  <div className="bg-accent-lighter border border-accent/60 p-6 md:p-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-10 gap-y-5">
                      {[
                        ...
                        <div key={label}>
                          <p className="text-xs font-bold uppercase tracking-[0.15em] text-gray-400 mb-1">{label}</p>
                ...
                <div id="who-needs" data-toc-section style={{ marginBottom: "5rem", paddingTop: "2.5rem", borderTop: "1px solid #e8ecf0" }}>
                  <h2 className="font-heading text-secondary mb-4" style={sectionHeadingStyle}>
                    Who needs EVLT?
                  </h2>
                  <p className="text-[16px] leading-[1.8] text-gray-500 mb-6">
                  ...
                  <ul className="space-y-4" style={{ listStyleType: "disc", paddingLeft: "1.5rem" }}>
                    {symptoms.map((s, i) => (
                      <li key={i} className="text-[16px] leading-[1.75] text-secondary pl-1">{s}</li>
                    ))}
                  </ul>
                </div>
                ...
                <div id="how-it-works" data-toc-section style={{ marginBottom: "5rem", paddingTop: "2.5rem", borderTop: "1px solid #e8ecf0" }}>
                  <h2 className="font-heading text-secondary mb-8" style={sectionHeadingStyle}>
                    How does EVLT work?
                  </h2>
                    ...
                    {steps.map((step, index) => (
                      <div key={index} className="relative">
                        ...
                        <div className="flex items-baseline gap-3 mb-2">
                          ...
                          <h3 className="font-heading text-xl font-normal text-secondary">{step.title}</h3>
                        </div>
                        <p className="text-[16px] leading-relaxed text-gray-500">{step.desc}</p>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {benefits.map((b, i) => (
                      <div key={i} className="flex gap-4 p-5 rounded-xl border border-gray-100 hover:border-primary/30 hover:bg-accent-lighter transition-all">
                        ...
                        <div>
                          <p className="font-semibold text-[15px] text-secondary mb-0.5">{b.title}</p>
                ...
                <div id="vs-surgery" data-toc-section style={{ marginBottom: "5rem", paddingTop: "2.5rem", borderTop: "1px solid #e8ecf0" }}>
                  <h2 className="font-heading text-secondary mb-2" style={sectionHeadingStyle}>
                    EVLT vs. traditional surgery
                  </h2>
                  <p className="text-[15px] text-gray-400 mb-6">Why modern laser therapy is the preferred choice</p>
                    ...
                    {comparisons.map((item, i) => (
                      <div key={i} className="grid grid-cols-2 border-b border-gray-100 last:border-0">
                        <div className="py-3 px-4 flex items-center gap-3 border-r border-gray-100 bg-white">
                          ...
                          <span className="text-[14px] font-medium text-secondary">{item.evlt}</span>
                        </div>
                        <div className="py-3 px-4 flex items-center gap-3 bg-white">
                          <div className="w-1.5 h-1.5 rounded-full bg-gray-300 flex-shrink-0" />
                          <span className="text-[14px] text-gray-400">{item.surgery}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div id="recovery" data-toc-section style={{ marginBottom: "5rem", paddingTop: "2.5rem", borderTop: "1px solid #e8ecf0" }}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="p-6 rounded-xl bg-accent-lighter border border-accent/40">
                      <h3 className="font-heading text-lg font-normal text-secondary mb-4">Recovery timeline</h3>
                    ...
                    <div className="p-6 rounded-xl bg-white border border-gray-100">
                      <h3 className="font-heading text-lg font-normal text-secondary mb-4">Is it safe?</h3>
                      <p className="text-[14px] leading-relaxed text-gray-500 mb-4">Yes. EVLT is FDA-approved. When performed by an experienced specialist:</p>
                      <ul className="space-y-3">
                  ...
                  <div className="space-y-3">
                    {faqs.map((faq, i) => (
                      <div key={i} className="border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        >
                          <span className="font-semibold text-[15px] text-secondary pr-4">{faq.q}</span>
                        ...
                        {openFaq === i && (
                          <div className="px-5 pb-5 text-[15px] leading-relaxed text-gray-500 border-t border-gray-100 pt-4">
                            {faq.a}
                          </div>
                        )}
                      </div>
              ...
              <div className="hidden lg:block w-[280px] xl:w-[300px] flex-shrink-0">
                <div className="sticky top-[88px]" style={{ maxHeight: "calc(100vh - 112px)", overflowY: "auto" }}>
                  ...
                  <div className="bg-accent-lighter py-5 px-6 mb-5 rounded-xl">
                    <h3 className="font-heading text-secondary mb-3" style={{ fontSize: "1.1rem", fontWeight: 400 }}>
                      Table of Contents
                    </h3>
                    <nav className="flex flex-col">
                      {tocSections.map((s) => (
                        <button key={s.id} onClick={() => scrollToSection(s.id)} className="text-left py-2 border-b border-secondary/5 last:border-0 cursor-pointer">
                          <span className={`text-[13px] underline underline-offset-4 decoration-1 transition-colors ${activeSection === s.id ? "text-secondary font-semibold" : "text-gray-400 hover:text-secondary"}`}>
                            {s.label}
                          </span>
                        </button>
                      ))}
                  ...
                  <div className="bg-white p-6 border border-gray-200 rounded-xl">
                    ...
                    <h4 className="font-heading text-[1.05rem] font-normal text-secondary mb-3 leading-snug">
                    ...
                    <a href="#" className="flex items-center justify-center gap-2 w-full rounded-full font-semibold text-[14px] py-3 text-white hover:opacity-90 cursor-pointer bg-primary">
                  ...
                  <div className="mt-5 p-5 bg-white border border-gray-200 rounded-xl space-y-4">
                    {[["Success rate", "95%+"], ["Procedure time", "30-60 min"], ["Recovery", "24-48 hrs"]].map(([label, value]) => (
                      <div key={label} className="flex items-center justify-between">
                        <span className="text-[12px] text-gray-400 uppercase tracking-wide">{label}</span>
