      ...
      <div className="max-w-[1440px] mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-sm border border-gray-200 bg-white">
          ...
          <div className="grid grid-cols-2 border-b border-gray-200">
            <div className="p-6 md:p-8 text-center border-r border-gray-200 bg-primary/10">
            ...
            <div className="p-6 md:p-8 text-center bg-gray-100">
              <h3 className="font-heading text-xl md:text-2xl font-bold text-gray-500">Traditional Surgery</h3>
            </div>
          </div>
          ...
          <div>
            {comparisons.map((item, index) => (
              <div key={index} className="grid grid-cols-2 last:border-0 transition-colors border-b border-gray-100">
                {/* EVLT Side */}
                <div className="p-6 md:p-8 flex items-center gap-4 border-r border-gray-100 bg-white">
                ...
                {/* Surgery Side */}
                <div className="p-6 md:p-8 flex items-center gap-4 bg-white">
